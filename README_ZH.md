...
ChatDome 正在从"被动应答式助手"进化为 **7×24 全天候主动安全守卫**。当前版本已包含 Command Pack、定时巡检、规则评估、告警历史与 Telegram 推送等基础能力；下面这些能力属于 Sentinel 的高级演进方向：
...
- [x] **Sentinel 基础能力**：Command Pack、定时巡检、规则评估、告警历史、Telegram 推送
